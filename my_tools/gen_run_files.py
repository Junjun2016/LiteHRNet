...
if __name__ == '__main__':
    ...
    # GPUS=8 GPUS_PER_NODE=8 CPUS_PER_TASK=1 tools/slurm_train.sh openmmlab mmseg1 dsn_exps/configs_mmseg/deeplabv3-r50_d8-832x832-real-contract_false-align_false-80k-cityscapes.py --seed=0   # noqa
    # with_cp = "GPUS=8 GPUS_PER_NODE=8 CPUS_PER_TASK=2 tools/slurm_train.sh openmmlab mmseg_{} {} --seed=0 --options model.backbone.with_cp=True"   # noqa
    with_cp = 'MASTER_PORT={} GPUS=4 GPUS_PER_NODE=4 CPUS_PER_TASK=5 tools/slurm_train.sh openmmlab mmseg_{} {} --seed=0'  # noqa
    without_cp = 'MASTER_PORT={} GPUS=4 GPUS_PER_NODE=4 CPUS_PER_TASK=5 tools/slurm_train.sh openmmlab mmseg_{} {} --seed=0 &'  # noqa
